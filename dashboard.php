  ...
  <div class="row gy-6">
    ...
    <div class="col-md-12 col-lg-4">
      <div class="card bg-label-warning">
        <div class="card-body text-nowrap">
          ...
          <a href="javascript:;" class="btn btn-sm btn-primary rounded-pill">View users</a>
        </div>
    ...
    <div class="col-md-12 col-lg-4">
      <div class="card bg-label-success">
        <div class="card-body text-nowrap">
          ...
          <h4 class="text-primary mb-0">42.8k</h4>
          <p class="mb-2">78% of target 🚀</p>
          <a href="javascript:;" class="btn btn-sm btn-primary rounded-pill">View Projects</a>
        </div>
    ...
    <div class="col-md-12 col-lg-4">
      <div class="card bg-label-secondary">
        <div class="card-body text-nowrap">
          <h5 class="card-title mb-0 flex-wrap text-nowrap">Total Category</h5>

          <h4 class="text-primary mb-0">42.8k</h4>
          <p class="mb-2">78% of target 🚀</p>
          <a href="javascript:;" class="btn btn-sm btn-primary rounded-pill">View Category</a>
        </div>
